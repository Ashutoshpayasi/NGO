                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6" style="display: flex; align-items: center;">
                        <div class="events-two__left">
                            ...
                            <p class="events-two__text">We at VeerNari Shakti believe that education is the cornerstone of a
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="about-two__right">
                            ...
                            <p class="about-two__text-1">We believe that every child deserves a chance to succeed, and
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="about-two__right">
                            ...
                            <p class="about-two__text-1">We understand that education is not just about providing access
                            ...
                            <ul class="list-unstyled about-two__points-2">
                                <li>
                                    ...
                                    <div class="text">
                                        ...
                                        <p>We provide infrastructure support to schools to ensure that they have the
                                ...
                                <li>
                                    ...
                                    <div class="text">
                                        ...
                                        <p>We believe that the quality of education is directly linked to the quality of
                            ...
                            <p class="about-two__text-1">Through these programs, we aim to create a brighter future for

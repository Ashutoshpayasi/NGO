...
<!-- Mirrored from layerdrops.com/oxpinshtml/main-html/become-volunteer.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Apr 2023 07:23:33 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, shrink-to-fit=no" />
    <title> support || VeerNari Shakti</title>
    <!-- favicons Icons -->
    ...
    <meta name="description" content="Join our community and make a positive impact on society. Learn more about our non-profit organization and discover ways to get involved. Join us now!" />
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            <div class="page-header-bg" style="background-image: url(assets/images/backgrounds/banner9.webp)">
            </div>
            <div class="container">
                    ...
                    <div class="col-xl-6 col-lg-6" style="display: flex; align-items: center;">
                        <div class="events-two__left">
                            <div class="section-title text-left">
                                <h2 class="section-title__title">Join Our Community
                                </h2>
                            </div>
                            <p class="events-two__text">By joining our community, you become part of a movement that is
                                dedicated to creating a better world. You'll have access to exclusive content, events,
                                and opportunities to get involved in our programs and services.
                            </p>
                        </div>
                    </div>
                            ...
                            <ul class="list-unstyled events-two__list">
                                <li>
                                    <div class="events-two__content">
                                        <h3 class="events-two__title"><a href="event-details.php">Sign Up for
                                                Newsletter</a></h3>
                                        <p>Our newsletter is a great way to stay informed about our latest news and
                                            updates. By signing up, you'll receive regular emails that highlight our
                                            impact, showcase our programs, and provide tips on how you can get involved
                                ...
                                <li>
                                    <div class="events-two__content">
                                        <h3 class="events-two__title"><a href="event-details.php">Follow Us on Social
                                                Media
                                            </a></h3>
                                        <p>Following us on social media is an easy way to stay connected and engaged
                                            with our organization. We regularly post updates, photos, and videos that
                                            showcase our work and highlight the impact we're making in the community.
                                            Plus, you can interact with us and other members of our community by
                                            commenting, sharing, and liking our posts.
                                        </p>
                                    </div>
                                </li>
                            </ul>
        ...
        <section class="become-volunteer-page">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h3 class="section-title__title">Let’s join our community to <br> become a volunteer</h3>
                </div>
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="become-volunteer-page__left">
                            <div class="become-volunteer-page__img">
                                <img src="assets/images/team/become-volunteer-img-1.png" alt="">
                            </div>
                            <div class="become-volunteer-page__content">
                                <h3 class="become-volunteer-page__title">Requirements</h3>
                                <p class="become-volunteer-page__text">To join our community, you must have a genuine
                                    interest in the goals and activities of the community, as well as a willingness to
                                    contribute positively to the community. This includes following our community
                                    guidelines, treating all members with respect, and maintaining a constructive and
                                ...
                                <ul class="list-unstyled become-volunteer__points">
                                    ...
                                    <li>
                                        ...
                                        <div class="text">
                                            <p>Adherence to our standards</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="accrodion-grp faq-one-accrodion faq-one-accrodion-1" data-grp-name="faq-one-accrodion-1">
                                <div class="accrodion">
                                    <div class="accrodion-title">
                                        <p>What is the community program of VeerNari Shakti?</p>
                                    </div>
                                    <div class="accrodion-content" style="display: none;">
                                        <div class="inner">
                                            <p>Our community program aims to bring like-minded individuals together who
                                                are committed to making a positive change in society.
                                            </p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion">
                                    <div class="accrodion-title">
                                        <p>How can I become a member of the VeerNari Shakti community?</p>
                                    </div>
                                    <div class="accrodion-content" style="display: none;">
                                        <div class="inner">
                                            <p>You can become a member of the VeerNari Shakti community by filling out the
                                                registration form on our website and joining our online community
                                                groups.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion active">
                                    <div class="accrodion-title">
                                        <p>What are the benefits of being a member of the VeerNari Shakti community?</p>
                                    </div>
                                    <div class="accrodion-content" style="">
                                        <div class="inner">
                                            <p>As a member of the VeerNari Shakti community, you'll have access to exclusive
                                                events, volunteer opportunities, and networking opportunities with
                                ...
                                <div class="accrodion last-chiled">
                                    <div class="accrodion-title">
                                        <p>Is there any membership fee to join the VeerNari Shakti community?</p>
                                    </div>
                                    <div class="accrodion-content" style="display: none;">
                                        <div class="inner">
                                            <p>No, there is no membership fee to join the VeerNari Shakti community. It is
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="faq-page__single">
                            <div class="accrodion-grp faq-one-accrodion faq-one-accrodion-2" data-grp-name="faq-one-accrodion-2">
                                <div class="accrodion">
                                    <div class="accrodion-title">
                                        <p>Can I volunteer with VeerNari Shakti if I am not a member of the community?</p>
                                    </div>
                                    <div class="accrodion-content" style="display: none;">
                                        <div class="inner">
                                            <p>Yes, you can still volunteer with VeerNari Shakti even if you are not a member
                                                of the community. However, being a member provides you with exclusive
                                ...
                                <div class="accrodion">
                                    <div class="accrodion-title">
                                        <p>Can I suggest any initiatives or ideas for VeerNari Shakti community programs?</p>
                                    </div>
                                    <div class="accrodion-content" style="display: none;">
                                        <div class="inner">
                                            <p>Yes, we welcome any suggestions or ideas from our community members. You
                                                can share your ideas through our online community groups or by reaching
                                ...
                                <div class="accrodion active">
                                    <div class="accrodion-title">
                                        <p>How often do community events and meetings take place?</p>
                                    </div>
                                    <div class="accrodion-content" style="">
                                        <div class="inner">
                                            <p>We organize community events and meetings on a regular basis. The
                                                frequency of events varies depending on the availability of our members
                                ...
                                <div class="accrodion last-chiled">
                                    <div class="accrodion-title">
                                        <p>How can I stay updated on VeerNari Shakti's community events and initiatives?</p>
                                    </div>
                                    <div class="accrodion-content" style="display: none;">
                                        <div class="inner">
                                            <p>You can stay updated on our community events and initiatives by
                                                subscribing to our newsletter, following us on social media, and joining
                                                our online community groups.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                            </div>
...
<!-- Mirrored from layerdrops.com/oxpinshtml/main-html/become-volunteer.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Apr 2023 07:23:35 GMT -->

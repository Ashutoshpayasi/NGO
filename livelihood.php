        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__inner">
                    ...
                    <h1 style="color:white;">Sustainable Livelihood </h1>
                </div>
            </div>
        </section>
        <!--Page Header End-->
                    ...
                    <div class="col-xl-6">
                        <div class="about-two__right">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title">Why Volunteer with VeerNari? </h2>
                            </div>
                            <p class="about-two__text-1">When you volunteer with VeerNari, you become a part of a
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="about-two__right">
                            ...
                            <p class="about-two__text-1">At VeerNari, we're committed to providing our volunteers with
                            ...
                            <p class="about-two__text-1">At VeerNari, we welcome volunteers from all walks of life. Our
